...
/**
 * \fn void Init_biases_weights(layer* Layer)
 * \author jeanne.morin
 * \brief Initialize matrix biases and weights of a layer to random double from -0.75 to 0.75
 * \param layer : layer which biases and weights need to be initialize
*/
...
/**
 * \fn layer *init_layze(int nbNeurons, int nbNeurons_prec)
 * \author jeanne.morin
 * \brief Initalize a layer and all its components.
 * \param nbNeurons : the number of neurons that the layer initalized has.
 * \param nbNeurons_prec : the number of neurons that the precedent layer of the current network has.
...
/**
 * \fn neuNet* init_network(int layer_size[], size_t nbLayers)
 * \author jeanne.morin
 * \brief initialize a network and all its components.
 * \param layer_size[] : the list of the number of neurons for each layer of the network initalized.
 * \param nbLayers : the number of layers the network initialized will have.
