...
/**
 * \fn float limit(Matrix *m, int begin, int end)
 * \brief Find the average of blank spaces between each words.
 * \param *m : Matrix of a line.
 * \param begin : Pos of the first line of the matrix.
 * \param end : Pos of the last line of the matrix.
 * \return float
 */
...
/**
 * \fn void lines_segmentation(List *listofparagraph)
 * \brief Make lines segmentation of a paragraph and stock lines in a list.
 * \param *listofparagraph : List which contains a paragraph.
 * \return void
 */
...
/**
 * \fn void words_segmentation(List *listoflines)
 * \brief Make words segmentation of a line and stock words in a list.
 * \param *listoflines : List which contains a line.
 * \return void
 */
